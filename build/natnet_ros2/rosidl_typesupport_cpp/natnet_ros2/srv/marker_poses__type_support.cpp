...
static const _MarkerPoses_Request_type_support_symbol_names_t _MarkerPoses_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, natnet_ros2, srv, MarkerPoses_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, natnet_ros2, srv, MarkerPoses_Request)),
  }
};
...
{
  return &::natnet_ros2::srv::rosidl_typesupport_cpp::MarkerPoses_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, natnet_ros2, srv, MarkerPoses_Request)() {
  return get_message_type_support_handle<natnet_ros2::srv::MarkerPoses_Request>();
}
...
static const _MarkerPoses_Response_type_support_symbol_names_t _MarkerPoses_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, natnet_ros2, srv, MarkerPoses_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, natnet_ros2, srv, MarkerPoses_Response)),
  }
};
...
{
  return &::natnet_ros2::srv::rosidl_typesupport_cpp::MarkerPoses_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, natnet_ros2, srv, MarkerPoses_Response)() {
  return get_message_type_support_handle<natnet_ros2::srv::MarkerPoses_Response>();
}
...
static const _MarkerPoses_type_support_symbol_names_t _MarkerPoses_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, natnet_ros2, srv, MarkerPoses)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, natnet_ros2, srv, MarkerPoses)),
  }
};
...
{
  return &::natnet_ros2::srv::rosidl_typesupport_cpp::MarkerPoses_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, natnet_ros2, srv, MarkerPoses)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<natnet_ros2::srv::MarkerPoses>();
}
